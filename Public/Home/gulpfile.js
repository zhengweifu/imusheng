...
gulp.task('basic-sass-css', function() {
    sass2css(["src/basic/sass/*.scss", "!src/basic/sass/msvariables.scss"], 'src/basic/css', 'Convert basic sass to css task complete');
});
...
gulp.task('styles-basic-sass', function() {
	buildSass(["src/basic/sass/*.scss", "!src/basic/sass/msvariables.scss"], "dist/basic/css", "Styles basic sass task complete")
});
...
gulp.task('watch', function() {
	gulp.watch('src/**/sass/*.scss', ['basic-sass-css']);
